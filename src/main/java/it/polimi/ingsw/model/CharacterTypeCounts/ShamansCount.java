 ...
 * for counting the number of Shaman characters within a specific Tribe.
 */
public class ShamansCount implements CharacterTypeCount {

    /**
     * Retrieves the total number of Shaman cards present in the given Tribe.
     *
     * @param t the {@link Tribe} instance from which to count the Shamans.
     * @return the number of Shaman characters in the specified tribe.
     */
    @Override
